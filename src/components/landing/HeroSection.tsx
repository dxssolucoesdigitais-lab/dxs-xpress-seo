  ...
  return (
    <section className="relative text-center py-20 md:py-32 lg:py-40 overflow-hidden">
      ...
      <div className="container mx-auto px-4 relative z-10">
        <h1 className="text-4xl md:text-5xl lg:text-6xl font-extrabold tracking-tight text-transparent bg-clip-text bg-gradient-to-r from-white to-cyan-400 leading-loose">
        ...
        <div className="mt-8 flex justify-center gap-4">
          <Button asChild size="lg" className="bg-cyan-500 hover:bg-cyan-400 text-black font-bold transition-all duration-300 hover:shadow-[0_0_20px_rgba(56,189,248,0.7)] hover:-translate-y-1">
            <Link to="/chat">{t('landingPage.hero.ctaButton')}</Link>
          </Button>
        </div>
        <p className="mt-4 text-sm text-muted-foreground">{t('landingPage.hero.freeCreditsNote')}</p>
      </div>
    </section>
  );
};
