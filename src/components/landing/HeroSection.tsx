  ...
  return (
    <section className="relative text-center py-20 md:py-32 lg:py-40 overflow-hidden">
      ...
      <div className="container mx-auto px-4 relative z-10">
        <h1 className="text-4xl md:text-5xl lg:text-6xl font-extrabold tracking-tight text-transparent bg-clip-text bg-gradient-to-r from-white to-cyan-400">
          Transforme Sua Loja de Dropshipping com SEO Inteligente
        </h1>
        <p className="mt-6 max-w-2xl mx-auto text-lg text-muted-foreground">
          Nos bastidores do XpressSEO, são mais de 6 especialistas de IA trabalhando em conjunto para entregar seu contéudo otimizado para você dominar os resultados de busca.
        </p>
