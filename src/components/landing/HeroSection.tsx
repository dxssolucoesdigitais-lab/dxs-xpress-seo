    ...
    <section className="relative text-center py-20 md:py-32 lg:py-40 overflow-hidden">
      ...
      <div className="container mx-auto px-4 relative z-10">
        ...
        <p className="mt-6 max-w-2xl mx-auto text-lg text-muted-foreground">
          O XpressSEO é seu copiloto de IA que cria conteúdo otimizado, encontra as melhores palavras-chave e estrutura suas páginas para dominar os resultados de busca.
        </p>
