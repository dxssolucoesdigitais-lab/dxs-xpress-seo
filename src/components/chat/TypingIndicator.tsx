...
const TypingIndicator: React.FC<TypingIndicatorProps> = ({ currentStep }) => {
  ...
  return (
    <div className="max-w-2xl mx-auto flex items-start gap-4">
      ...
      <div className="p-5 rounded-2xl rounded-tl-none bg-card border border-border relative max-w-[calc(100%-6rem)]">
        <p className="font-medium text-lg text-cyan-300 mb-2">{message}</p>
