...
const ChatInput: React.FC<ChatInputProps> = ({ project, isDisabled = false, onOptimisticMessageAdd, onOptimisticMessageRemove }) => {
  ...
  return (
    <>
      <div className="p-4 bg-background border-t border-border flex justify-center"> {/* Adicionado flex justify-center novamente */}
        <form onSubmit={handleSendMessage} className="relative max-w-xl">
          <textarea
