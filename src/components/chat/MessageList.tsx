  ...
  if (message.author === 'user') {
    return (
      <div className="flex items-start justify-end gap-4">
        <div className="flex-1 max-w-md p-4 rounded-2xl rounded-br-none bg-gradient-to-br from-purple-600 to-blue-600 text-white break-words">
          <p>{message.content}</p>
        </div>
  ...
  if (structuredContent?.type === 'structured_response' && Array.isArray(structuredContent.messages)) {
    return (
      <div className="flex items-start gap-4">
        ...
        <div className="flex-1 max-w-lg p-5 rounded-2xl rounded-tl-none glass-effect border border-border">
